...
def list_jobs(
    ...
    listing_type: ListingType | None = Query(
        None, description="Filter by listing type (ThirdParty or Direct)"
    ),
...
def get_job(
    ...
    return job_controller.get_job(
        session, job_id, listing_type=ListingType.ThirdParty, current_user=current_user
    )
...
def get_direct_job(
    ...
    return job_controller.get_job(
        session, job_id, listing_type=ListingType.Direct, current_user=current_user
    )
