...
from app.modules.auth.services.auth_service import AuthService, oauth_scheme
...
def get_optional_user(token: Optional[str] = Depends(oauth_scheme)) -> Optional[TokenPayload]:
    """
